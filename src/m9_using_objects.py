...
def circle_and_rectangle():
    ...
    """
    window = rg.RoseWindow()
    circle1 = rg.Circle(rg.Point(180, 115), 20)
    center = rg.Point(180, 115)
    rectangle = rg.Rectangle(rg.Point(50,125),rg.Point(100,175))
    circle1.fill_color = 'blue'
    center1 = rg.Point(75,150)
    circle1.attach_to(window)
...
def lines():
    ...
    line2 = rg.Line(rg.Point(200, 200), rg.Point(300, 200))
    line2.thickness = 10
